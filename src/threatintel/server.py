...
from .tools import register_tools, analyze_iocs_from_file, process_single_ioc
...
def run(
    ...
    vt_api_key: Optional[str] = typer.Option(None, help="VirusTotal API key (overrides environment)"),
    otx_api_key: Optional[str] = typer.Option(None, help="OTX API key (overrides environment)"),
    abuseipdb_api_key: Optional[str] = typer.Option(None, help="AbuseIPDB API key (overrides environment)"),
):
...
def batch(
    ...
    vt_api_key: Optional[str] = typer.Option(None, help="VirusTotal API key"),
    otx_api_key: Optional[str] = typer.Option(None, help="OTX API key"),
    abuseipdb_api_key: Optional[str] = typer.Option(None, help="AbuseIPDB API key"),
):
...
def interactive(
    ...
    async def _run_interactive():
        ...
        while True:
            ...
            from .tools import get_ioc_type, create_ioc_table
